 ...
 * @author User
 */
public class RevistaVentana2 extends JFrame implements ActionListener, KeyListener, FocusListener{
   private List<JLabel> jLabelList;
    ...
    public RevistaVentana2(String title) throws HeadlessException {
        this.setTitle(title);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource().equals(this.jButtonList.get(0))){
            ...
            this.revistaControl.crear(params);
